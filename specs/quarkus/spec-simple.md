...
It is based on these core technologies listed in "build process" section
...
- persistence, contains the repositories, these are based on the new "PanacheRepository"
