...
import org.goafabric.libraryservice.adapters.CalleeServiceAdapter
...
class TenantResolver(
    ...
    @Value("\${multi-tenancy.default-schema:PUBLIC}") private val defaultSchema: String,
    @Value("\${multi-tenancy.schema-prefix:_}") private val schemaPrefix: String
